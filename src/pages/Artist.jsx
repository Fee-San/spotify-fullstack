...
const Artist = () => {
  ...
  // console.log("Tamanho de Array:" + songsArrayFromArtist.length);
  ...
  return (
    ...
    >
      ...
      <Link to={`/songs/$(randomIdFromArtist)`}><FontAwesomeIcon className="single-item__icon single-item__icon--artist" icon={faCirclePlay} /></Link>
